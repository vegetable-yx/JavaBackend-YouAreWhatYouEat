...
public class VipEntity {
    ...
    private Collection<OrderNumberEntity> orderNumbersByUserName;
    ...
    public Collection<OrderNumberEntity> getOrderNumbersByUserName() {
        return orderNumbersByUserName;
    }

    public void setOrderNumbersByUserName(Collection<OrderNumberEntity> orderNumbersByUserName) {
        this.orderNumbersByUserName = orderNumbersByUserName;
    }
}
