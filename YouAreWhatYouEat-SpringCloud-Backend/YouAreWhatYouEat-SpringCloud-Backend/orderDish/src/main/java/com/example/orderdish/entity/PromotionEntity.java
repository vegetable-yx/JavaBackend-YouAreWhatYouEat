...
public class PromotionEntity {
    ...
    private Collection<HasdishEntity> hasdishesByPromotionId;
    ...
    public Collection<HasdishEntity> getHasdishesByPromotionId() {
        return hasdishesByPromotionId;
    }

    public void setHasdishesByPromotionId(Collection<HasdishEntity> hasdishesByPromotionId) {
        this.hasdishesByPromotionId = hasdishesByPromotionId;
    }
}
